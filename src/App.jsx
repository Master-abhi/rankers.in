  ...
  const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: "sarkari-news", element: <NewsPage /> },
        { path: "sarkari-jobs-notification", element: <JobsPage /> },
        { path: "sarkari-study", element: <StudyPage /> },
        { path: "sarkari-tests", element: <TestPage /> },
        { path: "sarkari-jobs-notification/:jobId", element: <JobShow /> },
        { path: "sarkari-tests/:testId", element: <TestStart /> },
        { path: "sarkari-tests/solution/:testId", element: <TestSolution /> },
